...
#' check for PDV/SPDV label consistency across files, flatten each file into tibbles, and combine them
...
#'   \item \code{combined} – a single tibble combining all files
