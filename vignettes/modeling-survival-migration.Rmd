...
This vignette will require the package `PITmodelR`, `marked`, and the `tidyverse` set of packages to function correctly. Please install them before moving forward with `install_packages()` or `remotes::install_github()`.
